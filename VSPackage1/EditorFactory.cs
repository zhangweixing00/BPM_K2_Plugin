...
namespace star.VSPackage1
{
    ...
    /// </summary>
    [Guid(GuidList.guidVSPackage1EditorFactoryString)]
    public sealed class EditorFactory : IVsEditorFactory, IDisposable
    {
        private VSPackage1Package editorPackage;
        private ServiceProvider vsServiceProvider;


        public EditorFactory(VSPackage1Package package)
        {
                        ...
                        out int pgrfCDW)
        {
            ...
            pguidCmdUI = GuidList.guidVSPackage1EditorFactory;
            pgrfCDW = 0;
