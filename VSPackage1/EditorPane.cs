...
namespace star.VSPackage1
{
    ...
    //     - An empty vspackage1 file in the same directory as NewFileItems.vsdir. In
    //       our case we chose MyExtFile.vspackage1. Note this file name appears in Editor.vsdir
    ...
    //             be named as MyExtFile1.vspackage1, MyExtFile2.vspackage1... etc.
    ///////////////////////////////////////////////////////////////////////////////
    // Editor.vsdir contents:-
    //    MyExtFile.vspackage1|{3085E1D6-A938-478e-BE49-3546C09A1AB1}|#106|80|#109|0|401|0|#107
    //
    // The fields in order are as follows:-
    //    - MyExtFile.vspackage1 - our empty vspackage1 file
                                ...
                                IVsToolboxUser      //Sends notification about Toolbox items to the owner of these items
    {
        ...
        private const string MyExtension = ".vspackage1";
        ...
        #region Fields
        private VSPackage1Package myPackage;
        ...
        public EditorPane(VSPackage1Package package)
            : base(null)
        {
            PrivateInit(package);
        }
        ...
        private void PrivateInit(VSPackage1Package package)
        {
            myPackage = package;
            loading = false;
        ...
        private void DisplayContextMenuAt(Point point)
        {
            ...
            CommandID contextMenuID = new CommandID(GuidList.guidVSPackage1CmdSet, PkgCmdIDList.IDMX_RTF);
